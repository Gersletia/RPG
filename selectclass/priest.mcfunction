...
scoreboard players set @s Priest_S1_CT 0
scoreboard players set @s Priest_A3_CT 0

## 給予所有職業相關Item
give @s carrot_on_a_stick{display:{Name:'{"text":"聖域展開","color":"aqua","italic":false}'},Unbreakable:1b,Priest_S1:1b} 1
