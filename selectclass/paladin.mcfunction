...
scoreboard players set @s Paladin_S1_CT 0
scoreboard players set @s .corrosion_Paladin_A3 0
scoreboard players set @s .temp_Paladin_S1 0

## 給予所有職業相關Item
give @s carrot_on_a_stick{display:{Name:'{"text":"聖痕","color":"aqua","italic":false}'},Unbreakable:1b,Paladin_S1:1b} 1
