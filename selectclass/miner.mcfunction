...
scoreboard players set @s Miner_S1_CT 0
scoreboard players set @s .exhaust_Miner_A3 0

## 設定職業Attributes

## 給予所有職業相關Item
give @s carrot_on_a_stick{display:{Name:'{"text":"強化直覺","color":"aqua","italic":false}'},Unbreakable:1b,Miner_S1:1b} 1
