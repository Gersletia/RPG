...
scoreboard players set @s Mage_mana 100

## 設定職業Attributes

## 給予所有職業相關Item
give @s carrot_on_a_stick{display:{Name:'{"text":"灼熱魔法","color":"aqua","italic":false}'},Unbreakable:1b,Mage_A1:1b} 1
give @s carrot_on_a_stick{display:{Name:'{"text":"冰凍魔法","color":"aqua","italic":false}'},Unbreakable:1b,Mage_A2:1b} 1
give @s carrot_on_a_stick{display:{Name:'{"text":"空間魔法","color":"aqua","italic":false}'},Unbreakable:1b,Mage_A3:1b} 1
