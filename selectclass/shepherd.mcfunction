...
scoreboard players set @s Shepherd_S1_CT 0
scoreboard players set @s Shepherd_A1_CT 0
scoreboard players set @s Shepherd_A2_CT 0

## 設定職業Attributes

## 給予所有職業相關Item
give @s carrot_on_a_stick{display:{Name:'{"text":"召喚代罪羔羊","color":"aqua","italic":false}'},Unbreakable:1b,Shepherd_S1:1b} 1
