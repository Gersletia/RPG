...
scoreboard players set @s .is_Necromancer 0
scoreboard players set @s .is_Necromancer_CT 0
scoreboard players set @s Necromancer_S1_CT 0

## 設定職業Attributes

## 給予所有職業相關Item
give @s carrot_on_a_stick{display:{Name:'{"text":"靈魂出竅之術","color":"aqua","italic":false}'},Unbreakable:1b,Necromancer_S1:1b} 1
